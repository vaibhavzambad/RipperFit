...
LOCK TABLES `designation_level` WRITE;
/*!40000 ALTER TABLE `designation_level` DISABLE KEYS */;
/*!40000 ALTER TABLE `designation_level` ENABLE KEYS */;
UNLOCK TABLES;
