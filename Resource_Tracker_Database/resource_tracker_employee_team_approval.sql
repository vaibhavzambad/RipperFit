...
CREATE TABLE `employee_team_approval` (
  ...
  `approveeId` char(10) NOT NULL,
  `status` varchar(20) NOT NULL,
  PRIMARY KEY (`employeeId`),
  KEY `approveeId` (`approveeId`),
  CONSTRAINT `employee_team_approval_ibfk_1` FOREIGN KEY (`employeeId`) REFERENCES `employee` (`employeeId`),
  CONSTRAINT `employee_team_approval_ibfk_2` FOREIGN KEY (`approveeId`) REFERENCES `employee` (`employeeId`)
