...
CREATE TABLE `resource_request` (
  ...
  `requestorId` char(10) NOT NULL,
  `current_approval_level` int(11) NOT NULL,
  ...
  CONSTRAINT `resource_request_ibfk_1` FOREIGN KEY (`resourceId`) REFERENCES `resource` (`resourceId`),
  CONSTRAINT `resource_request_ibfk_2` FOREIGN KEY (`requestorId`) REFERENCES `employee` (`employeeId`)
